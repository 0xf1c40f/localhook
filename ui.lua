...
local drag = function(obj, latency)
    ...
    local function updateInput(input)
        ...
        TweenService:Create(obj, TweenInfo.new(latency), {Position = newPosition}):Play()
    end
...
function library:Introduction()
    ...
    xsx.Text = 'Welcome '.. game:GetService('Players').LocalPlayer.Name
...
a['TextButton']['BackgroundColor3'] = Color3.fromRGB(0, 0, 0)
a['TextButton']['BackgroundTransparency'] = 0.6
a['TextButton']['BorderColor3'] = Color3.fromRGB(255, 255, 255)
a['TextButton']['BorderSizePixel'] = 0
a['TextButton']['Text'] = 'Open'
a['TextButton']['TextColor3'] = Color3.fromRGB(255, 255, 255)
a['TextButton']['Name'] = 'TextButton'
a['TextButton']['Parent'] = a['ScreenGui']

a['UICorner']['CornerRadius'] = UDim.new(0, 3)
a['UICorner']['Name'] = 'openv2'
